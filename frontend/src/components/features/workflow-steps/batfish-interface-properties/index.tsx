    ...
    <div className="flex flex-col gap-4">
      <div className="space-y-1.5">
        ...
        <p className="text-[11px] leading-4 text-muted-foreground">
          Optional. Leave empty to return interfaces on every node.
        </p>
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="e.g. Description, Primary_Address"
          className="h-8 font-mono text-xs"
        />
        <p className="text-[11px] leading-4 text-muted-foreground">
        ...
        <div className="flex flex-wrap gap-1 pt-0.5">
          {BATFISH_INTERFACE_PROPERTY_KEYS.map((property) => (
            <button
              key={property}
              type="button"
        ...
        {routeEmptyToDevices && propertiesList.length > 1 && (
          <div className="space-y-1.5 pt-1">
            ...
            <p className="text-[11px] leading-4 text-muted-foreground">
              ...
              (default) routes an interface if at least one requested property
              is empty; <span className="font-mono">all</span> routes it only
              if every requested property is empty.
            </p>
          </div>
        )}
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="batfish_interface_properties"
          className="h-8 font-mono text-xs"
        />
        <p className="text-[11px] leading-4 text-muted-foreground">
