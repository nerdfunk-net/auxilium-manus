...
(pushing) sides of a Wait & Run batch approval pause.

A "Run next batch"/"Run all remaining" click can race the durable wait's own
registration with the Hatchet engine: the run is marked "paused" in the DB
