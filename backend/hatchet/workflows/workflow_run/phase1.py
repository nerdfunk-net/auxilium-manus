...
one node at a time, with per-node durable debug pauses ("Next Step"), and stop
either at a terminal status or at the first inventory step that requests
fan-out.
...
from services.execution.run_events import STEP_EVENT_LOOKBACK, debug_step_event_key
